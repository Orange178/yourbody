...
class ContactMailer
{
     ...
     * @var string
     */
    private static $emailFrom = '@yandex.ru';
    /**
     * E-mail получателя
     * @var string
     */
    private static $emailTo = '@list.ru';
     ...
     * @return boolean
     */
    public static function send($name,$email,$phone,$adress,$qty,$color)
    {
        ...
        $mailer->setFrom(self::$emailFrom, 'Заявка с сайта');
